...
def count_coins(total):
    ...
    '''
    def count_ways(cnt, coins):
        if cnt == 0:
            return 1
        elif cnt < 0 or coins == None:
            return 0

        return count_ways(cnt, next_smaller_coin(coins)) + count_ways(cnt - coins, coins)
    ...
    def count_ways(cnt, coins):
        ...
        return count_ways(cnt, next_larger_coin(coins)) + count_ways(cnt - coins, coins)
